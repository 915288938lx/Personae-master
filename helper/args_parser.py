...
# stock_codes = ["601398", "000651", "601998", "000002"]
...
stock_spider_parser.add_argument("-e", "--end", default="2019-07-19")
...
future_spider_parser.add_argument("-e", "--end", default="2019-07-19")
...
model_launcher_parser.add_argument("-e", "--end", default="2019-07-19")
